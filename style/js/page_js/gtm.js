...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_dimension":["list",["map","index","2","dimension",["macro",2]],["map","index","3","dimension",["macro",1]]],
      "vtp_enableEcommerce":true,
      "vtp_trackingId":"UA-43695756-1",
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return!(50\u003C=",["escape",["macro",9],8,16],")})();"]
    },{
      "function":"__u",
      "vtp_component":"PATH",
      ...
      "function":"__j",
      "vtp_name":"TotalQuantityAddedToCart"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
  ...
  "tags":[{
      ...
      "vtp_conversionId":"739173473",
      "vtp_conversionLabel":"fN2wCMWA3rYBEOHIu-AC",
      "vtp_url":["macro",16],
      ...
      "vtp_eventCategory":"AlaatvEcommerce",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",3],
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",3],
      "vtp_eventAction":["template","Checkout step ",["macro",22]],
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",3],
      "vtp_eventAction":["template","Checkout option, step ",["macro",24]],
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",3],
      "vtp_eventAction":"eec.promotionClick",
      ...
      "vtp_uniqueTriggerId":"10149333_9",
      ...
      "metadata":["map"],
      "once_per_load":true,
      "vtp_html":"\u003Cscript type=\"text\/javascript\" src=\"https:\/\/s1.mediaad.org\/serve\/10619\/retargeting.js\"\u003E\u003C\/script\u003E",
      ...
      "once_per_load":true,
      "vtp_overrideGaSettings":false,
      "vtp_optimizeContainerId":"GTM-5GP69HT",
      "vtp_gaSettings":["macro",3],
      "tag_id":29
    },{
      "function":"__html",
      ...
      "metadata":["map"],
      "once_per_load":true,
      "vtp_html":"\u003Cscript\u003E!function(c,a,b){c.yektanetAnalyticsObject=b;c[b]=c[b]||function(){c[b].q.push(arguments)};c[b].q=c[b].q||[];var d=new Date;d=d.getFullYear().toString()+\"0\"+d.getMonth()+\"0\"+d.getDate()+\"0\"+d.getHours();var e=a.getElementsByTagName(\"script\")[0];a=a.createElement(\"script\");a.id=\"ua-script-yn-1855-adv\";a.dataset.analyticsobject=b;a.async=1;a.type=\"text\/javascript\";a.src=\"https:\/\/cdn.yektanet.com\/rg_woebegone\/scripts_v2\/yn-1855-adv\/rg.complete.js?v\\x3d\"+d;e.parentNode.insertBefore(a,e)}(window,document,\n\"yektanet\");\u003C\/script\u003E",
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "metadata":["map"],
      "once_per_load":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E(function(){var a=new Date;a=a.getFullYear().toString()+\"0\"+a.getMonth()+\"0\"+a.getDate()+\"0\"+a.getHours();var c=document.getElementsByTagName(\"head\")[0],b=document.createElement(\"script\");b.type=\"text\/javascript\";b.async=!0;b.src=\"https:\/\/app.najva.com\/static\/js\/scripts\/AlaaTv-website-5143-6c56f182-8f3c-4b3f-b40f-6e3c9d0f2f66.js?v\\x3d\"+a;c.appendChild(b)})();\u003C\/script\u003E",
  ...
  "rules":[
    ...
    [["if",16],["add",15]],
    [["if",17],["add",16]],
    [["if",0],["unless",18,19,20],["add",21,19,22]]]
},
"runtime":[]
...
return null},yd=!1;if(H.querySelectorAll)try{var zd=H.querySelectorAll(":root");zd&&1==zd.length&&zd[0]==H.documentElement&&(yd=!0)}catch(a){}var vd=yd;var Od={},M=null,Pd=Math.random();Od.B="GTM-PNP8RDW";Od.Yb="9n1";Od.Nh="";var Qd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Rd={__paused:!0,__tg:!0},Sd;for(Sd in Qd)Qd.hasOwnProperty(Sd)&&(Rd[Sd]=!0);var Td="www.googletagmanager.com/gtm.js";
var Ud=Td,Vd=Ea(""),Wd=null,Xd=null,Yd="//www.googletagmanager.com/a?id="+Od.B+"&cv=39",Zd={},$d={},ae=function(){var a=M.sequence||1;M.sequence=a+1;return a};
...
Z.a.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(x){for(var B=[],A=x.split(","),z=0;z<A.length;z++){var D=Number(A[z]);if(isNaN(D))return[];p.test(A[z])||B.push(D)}return B}function c(){var x=0,B=0;return function(){var A=$i(),z=A.height;x=Math.max(u.scrollLeft+A.width,x);B=Math.max(u.scrollTop+z,B);return{Ag:x,Bg:B}}}function d(){q=X("self");
v=q.document;u=v.scrollingElement||v.body&&v.body.parentNode;y=c()}function e(x,B,A,z){var D=l(B),G={},L;for(L in D){G.Ka=L;if(D.hasOwnProperty(G.Ka)){var N=Number(G.Ka);x<N||(Yl({event:"gtm.scrollDepth","gtm.scrollThreshold":N,"gtm.scrollUnits":A.toLowerCase(),"gtm.scrollDirection":z,"gtm.triggers":D[G.Ka].join(",")}),wl("sdl",B,function(T){return function(W){delete W[T.Ka];return W}}(G),{}))}G={Ka:G.Ka}}}function f(){var x=y(),B=x.Ag,A=x.Bg,z=B/u.scrollWidth*100,D=A/u.scrollHeight*100;e(B,"horiz.pix",
r.Wb,t.me);e(z,"horiz.pct",r.Vb,t.me);e(A,"vert.pix",r.Wb,t.ye);e(D,"vert.pct",r.Vb,t.ye);vl("sdl","pending",!1)}function h(){var x=250,B=!1;v.scrollingElement&&v.documentElement&&q.addEventListener&&(x=50,B=!0);var A=0,z=!1,D=function(){z?A=Sl(D,x):(A=0,f(),cm("sdl")&&!a()&&(Uc(q,"scroll",G),Uc(q,"resize",G),vl("sdl","init",!1)));z=!1},G=function(){B&&y();A?z=!0:(A=Sl(D,x),vl("sdl","pending",!0))};return G}function k(x,B,A){if(B){var z=b(String(x));wl("sdl",A,function(D){for(var G=0;G<z.length;G++){var L=
String(z[G]);D.hasOwnProperty(L)||(D[L]=[]);D[L].push(B)}return D},{})}}function l(x){return xl("sdl",x,{})}function m(x){J(x.vtp_gtmOnSuccess);var B=x.vtp_uniqueTriggerId,A=x.vtp_horizontalThresholdsPixels,z=x.vtp_horizontalThresholdsPercent,D=x.vtp_verticalThresholdUnits,G=x.vtp_verticalThresholdsPixels,L=x.vtp_verticalThresholdsPercent;switch(x.vtp_horizontalThresholdUnits){case r.Wb:k(A,B,"horiz.pix");break;case r.Vb:k(z,B,"horiz.pct")}switch(D){case r.Wb:k(G,B,"vert.pix");break;case r.Vb:k(L,
B,"vert.pct")}cm("sdl")?xl("sdl","pending")||(w||(d(),w=!0),J(function(){return f()})):(d(),w=!0,u&&(dm("sdl"),vl("sdl","pending",!0),J(function(){f();if(a()){var N=h();Tc(q,"scroll",N);Tc(q,"resize",N)}else vl("sdl","init",!1)})))}var p=/^\s*$/,r={Vb:"PERCENT",Wb:"PIXELS"},t={ye:"vertical",me:"horizontal"},q,v,u,w=!1,y;(function(x){Z.__sdl=x;Z.__sdl.b="sdl";Z.__sdl.g=!0;Z.__sdl.priorityOverride=0})(function(x){x.vtp_triggerStartOption?m(x):Ck(function(){m(x)})})}();
...
""!==m.vtp_trackerName&&(A=m.vtp_trackerName,B=A+"."):(A="gtm"+ae(),B=A+".");var z=function(ma){var O=[].slice.call(arguments,0);O[0]=B+O[0];x.apply(window,O)},D=function(ma,O){return void 0===O?O:ma(O)},G=function(ma,O){if(O)for(var Ra in O)O.hasOwnProperty(Ra)&&z("set",ma+Ra,O[Ra])},L=function(){var ma=function(So,Qk,To){if(!Ua(Qk))return!1;for(var Ad=Ia(Object(Qk),To,[]),Ug=0;Ad&&Ug<Ad.length;Ug++)z(So,Ad[Ug]);return!!Ad&&0<
Ad.length},O;if(m.vtp_useEcommerceDataLayer){var Ra=!1;Ra||(O=Xl("ecommerce",1))}else m.vtp_ecommerceMacroData&&(O=m.vtp_ecommerceMacroData.ecommerce);if(!Ua(O))return;O=Object(O);var ob=Ia(y,"currencyCode",O.currencyCode);void 0!==ob&&z("set","&cu",ob);ma("ec:addImpression",O,"impressions");if(ma("ec:addPromo",O[O.promoClick?"promoClick":
"promoView"],"promotions")&&O.promoClick){z("ec:setAction","promo_click",O.promoClick.actionField);return}for(var pb="detail checkout checkout_option click add remove purchase refund".split(" "),qb="refund purchase remove checkout checkout_option add click detail".split(" "),$a=0;$a<pb.length;$a++){var rb=O[pb[$a]];if(rb){ma("ec:addProduct",rb,"products");z("ec:setAction",pb[$a],rb.actionField);if(ue)for(var Gb=0;Gb<qb.length;Gb++){var Hc=O[qb[Gb]];if(Hc){Hc!==rb&&E(13);break}}break}}},
...
Z.a.opt=["google"],function(){var a;(function(b){Z.__opt=b;Z.__opt.b="opt";Z.__opt.g=!0;Z.__opt.priorityOverride=0})(function(b){var c={};if(b.vtp_gaSettings){var d=b.vtp_gaSettings;n(Nm(d.vtp_fieldsToSet,"fieldName","value"),c);b.vtp_gaSettings=null;d.vtp_fieldsToSet=void 0;var e=n(d);b=n(b,e)||{}}n(Nm(b.vtp_fieldsToSet,"fieldName","value"),c);var f=Gh(b.vtp_functionName);if(ua(f)){f.r=!0;var h="",k="";b.vtp_setTrackerName&&
"string"===typeof b.vtp_trackerName?""!==b.vtp_trackerName&&(k=b.vtp_trackerName,h=k+"."):(k="gtm"+ae(),h=k+".");var l={name:!0,clientId:!0,sampleRate:!0,siteSpeedSampleRate:!0,alwaysSendReferrer:!0,allowAnchor:!0,allowLinker:!0,cookieName:!0,cookieDomain:!0,cookieExpires:!0,cookiePath:!0,cookieUpdate:!0,legacyCookieDomain:!0,legacyHistoryImport:!0,storage:!0,useAmpClientId:!0,storeGac:!0},m={allowAnchor:!0,allowLinker:!0,alwaysSendReferrer:!0,anonymizeIp:!0,cookieUpdate:!0,exFatal:!0,forceSSL:!0,
javaEnabled:!0,legacyHistoryImport:!0,nonInteraction:!0,useAmpClientId:!0,useBeacon:!0,storeGac:!0},p=function(w,y,x){var B=0,A;for(A in w)if(w.hasOwnProperty(A)&&(x&&l[A]||!x&&void 0===l[A])){var z=m[A]?Ea(w[A]):w[A];"anonymizeIp"!==A||z||(z=void 0);y[A]=z;B++}return B},r={name:k};p(c,r,!0);var t={"&gtm":si(!0)};p(c,t,!1);var q=encodeURI(Kg("https:","http:","//www.google-analytics.com/"+(b.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js"),!!c.forceSSL));f("create",b.vtp_trackingId,r);f(h+
"set",t);f(h+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(h+"require","render");a||(a=!0,P(q,function(){return Eh().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var v=X("dataLayer"),u=v&&v.hide;u&&(u.end||!0===u["GTM-PNP8RDW"])&&(u[b.vtp_optimizeContainerId]=!0)}else J(b.vtp_gtmOnFailure)})}();
...
(b.vtp_enableCrossDomain&&!1===b.vtp_acceptIncoming||(b.vtp_enableCrossDomain||$f())&&rg(a,k));og(k);tg(["aw","dc"],k);Cg(h,k);var l=e;if(b.vtp_enableCrossDomainFeature&&b.vtp_enableCrossDomain&&b.vtp_linkerDomains){var m=b.vtp_linkerDomains.toString().replace(/\s+/g,"").split(",");sg(a,m,b.vtp_urlPosition,!!b.vtp_formDecoration,l)}var p=Xl(C.M);Xi(!1,void 0!=p&&!1!==p);b.vtp_enableUrlPassthroughFeature&&b.vtp_enableUrlPassthrough&&vg()})}();
...
0})(function(h){function k(){q("gdpr_consent",Vi());}function l(){}function m(w){var y=!0;w&&l();y&&b.push(p)}zh();var p={google_basket_transaction_type:"purchase",google_conversion_domain:"",google_conversion_id:h.vtp_conversionId,
google_conversion_label:h.vtp_conversionLabel,google_conversion_value:h.vtp_conversionValue||0,google_remarketing_only:!1,onload_callback:h.vtp_gtmOnSuccess,gtm_onFailure:h.vtp_gtmOnFailure,google_gtm:si()};h.vtp_rdp&&(p.google_restricted_data_processing=!0);void 0!=Xl(C.M)&&!1!==Xl(C.M)&&(p.google_gtm_url_processor=function(w){return w=Zg(w)});var r=function(w){return function(y,
x,B){var A="DATA_LAYER"==w?Xl(B):h[x];A&&(p[y]=A)}},t=r("JSON");t("google_conversion_currency","vtp_currencyCode");t("google_conversion_order_id","vtp_orderId");h.vtp_enableProductReporting&&(t=r(h.vtp_productReportingDataSource),t("google_conversion_merchant_id","vtp_awMerchantId","aw_merchant_id"),t("google_basket_feed_country","vtp_awFeedCountry","aw_feed_country"),t("google_basket_feed_language","vtp_awFeedLanguage","aw_feed_language"),t("google_basket_discount","vtp_discount","discount"),t("google_conversion_items",
"vtp_items","items"),p.google_conversion_items&&p.google_conversion_items.map&&(p.google_conversion_items=p.google_conversion_items.map(function(w){return{value:w.price,quantity:w.quantity,item_id:w.id}})));var q=function(w,y){void 0!==y&&((p.google_additional_conversion_params=p.google_additional_conversion_params||{})[w]=y)},v=function(w){return function(y,x,B,A){var z="DATA_LAYER"==w?Xl(B):h[x];A(z)&&q(y,z)}};h.vtp_transportUrl&&(p.google_transport_url=h.vtp_transportUrl);var u=ei(h.vtp_transportUrl,
"/pagead/conversion_async.js");u||(u=-1==navigator.userAgent.toLowerCase().indexOf("firefox")?"//www.googleadservices.com/pagead/conversion_async.js":"https://www.google.com/pagead/conversion_async.js");h.vtp_enableNewCustomerReporting&&(t=v(h.vtp_newCustomerReportingDataSource),t("vdnc","vtp_awNewCustomer","new_customer",function(w){return void 0!=w&&""!==w}),t("vdltv","vtp_awCustomerLTV","customer_lifetime_value",function(w){return void 0!=w&&""!==w}));!h.hasOwnProperty("vtp_enableConversionLinker")||
h.vtp_enableConversionLinker?(h.vtp_conversionCookiePrefix&&(p.google_gcl_cookie_prefix=h.vtp_conversionCookiePrefix),p.google_read_gcl_cookie_opt_out=!1):p.google_read_gcl_cookie_opt_out=!0;"1"===Tf(!1)._up&&q("gtm_up","1");k();(function(){ld()?ud(function(){k();var w=sd(C.o),y=!w&&void 0!=Xl(C.M)&&!1!==Xl(C.M);!h.vtp_transportUrl&&y&&(p.google_transport_url="https://pagead2.googlesyndication.com/");q("gcs",td());m(w);w||od(function(){k();p=n(p);!h.vtp_transportUrl&&p.google_transport_url&&delete p.google_transport_url;
q("gcs",td());q("gcu","1");m(!0)},C.o)},[C.o]):m(!0)})();a||(a=!0,P(u,f(),e(u)))})}();




Z.a.hid=["google"],function(){(function(a){Z.__hid=a;Z.__hid.b="hid";Z.__hid.g=!0;Z.__hid.priorityOverride=0})(function(){return ql.Ub})}();
